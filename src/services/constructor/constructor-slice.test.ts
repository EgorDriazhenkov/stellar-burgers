import { addIngredient, constructorReducer, swapIngredient, removeIngredient, clearBurger } from "./constructor-slice";
import { testBunOne, testBunTwo, testFilling, testSauce } from "../../mocks/test-data";
